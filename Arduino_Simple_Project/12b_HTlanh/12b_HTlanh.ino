...
void loop() {
  ...
  nhietdoChinh = nhanMaytinh1*10;
  nhietdoR = map(kqADC6,0,1023,-100,400);

  if(nhietdoR <= (nhietdoChinh-10) {hienthiLED(20); LED1 = 1;}
  if(nhietdoR >= (nhietdoChinh+10) {hienthiLED(16); LED1 = 0;}
